                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php 
                            ...
                            $sql = "SELECT baiviet.ma_bviet, baiviet.ten_bhat, baiviet.tomtat, theloai.ten_tloai, 
                                    tacgia.ten_tgia, baiviet.ngayviet, baiviet.noidung 
                                    FROM baiviet 
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit_article.php?id=<?php echo $row['ma_bviet']; ?>"><i
                                        class="fa-solid fa-pen-to-square"></i></a>
                            </td>
                            <td>
                                <a onclick="return confirm('Bạn có muốn xóa bài viết này không ?');"
                                    href="delete_article.php?id=<?php echo $row['ma_bviet']; ?>"><i
